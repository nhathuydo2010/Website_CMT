...
const product = {
  ...
  specs: [
    ...
    "Thời gian khởi động: 36 giây (có kích hoạt), 30 giây (không kích hoạt)",
    ...
    "Thời gian bản sao đầu tiên: Đen trắng 4.1 giây, Màu 5.4 giây (A4 LEF)",
    "Tốc độ sao chụp liên tục A4 LEF: Đen trắng/Màu 75 trang/phút",
    "Tốc độ sao chụp A4: Đen trắng/Màu 54 trang/phút",
    "Tốc độ sao chụp JIS B4: Đen trắng/Màu 43 trang/phút",
    "Tốc độ sao chụp A3: Đen trắng/Màu 37 trang/phút",
    ...
    "Mức tiêu thụ điện: Tối đa 2.4 kW, nghỉ 0.5 W, chế độ thấp 134 W, sẵn sàng 193 W",
    ...
    "Độ phân giải in (PostScript): 2.400 x 2.400 dpi (tiêu chuẩn, chất lượng cao, độ phân giải cao)",
    "Ngôn ngữ mô tả trang: PCL5 / PCL6 (chuẩn), Adobe PostScript 3 (tùy chọn)",
    "Hệ điều hành hỗ trợ (PCL): Windows 10/8.1/Server 2012–2019, macOS 10.12–11",
    "Hệ điều hành hỗ trợ (PostScript): Windows 10/8.1/Server 2012–2019, macOS 10.12–11",
    "Kết nối in: Ethernet 1000BASE-T/100BASE-TX/10BASE-T, USB 3.0/2.0, Wi-Fi (tùy chọn)",
    "Kiểu quét: Màu",
    "Độ phân giải quét: 600, 400, 300, 200 dpi",
    "Tốc độ quét: Theo tốc độ SPDF",
    ...
    "Tốc độ sao chụp từ SPDF (1 mặt): Đen trắng/Màu 75 trang/phút",
    "Tốc độ quét từ SPDF: Đen trắng/Màu 135 trang/phút",
    "Tốc độ quét 1 lần 2 mặt: Đen trắng/Màu 270 trang/phút",
      ...
      <div className="mt-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 w-full">
          ...
          <h3 className="text-[30px] font-bold text-red-700 mb-2">
            Máy photocopy màu FUJIFILM Apeos C7580
          </h3>
           <h4 className="text-lg font-semibold text-blue-700 mb-2">
            Thời đại mới, Apeos mới
          </h4>
          <p className="text-black text-justify mb-4">
            <strong>Máy photocopy màu FUJIFILM Apeos C7580</strong> không chỉ đơn thuần là một thiết bị in ấn mà còn là một hệ thống quản lý tài liệu toàn diện. Với tốc độ in vượt trội, khả năng bảo mật cao và tích hợp công nghệ hiện đại, máy là giải pháp lý tưởng cho các doanh nghiệp cần tối ưu hóa quy trình làm việc và đảm bảo chất lượng in ấn cao nhất.
          </p>
