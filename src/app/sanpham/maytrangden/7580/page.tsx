...
const product = {
  ...
  specs: [
    ...
    'Tốc độ sao in: 75 trang/phút (A4 LEF), 79 trang/phút (JIS B5 LEF)',
    ...
    'Tốc độ sao chụp qua DADF (A4 LEF, 1 mặt): Đen trắng 75 trang/phút',
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            ...
            <li>Tốc độ In/sao chụp qua DADF 75 trang/phút</li>
          ...
          <div className="relative w-full max-w-[350px] border border-red-700 mt-4 rounded">
            {/* Ruy băng khuyến mãi */}
            <div className="absolute -top-[1px] -left-[11px] z-10">
              <div className="relative flex items-center bg-red-700 text-white font-bold text-sm h-[32px] pl-3 pr-5 rounded-tr-md">
            ...
            <div className="pt-8 pb-2 px-2 text-[15px] text-gray-800">
      ...
      <div className="mt-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 w-full">
          ...
          <p className="text-black text-justify mb-4">
            <strong>Apeos 7580</strong> là một thiết bị mới của hãng FujiFilm. Máy có tốc độ 75 trang/phút với đầy đủ bộ tính năng Copy-In-Scan kèm theo các tiện ích gia tăng được thiết kế tỉ mỉ đến từng chi tiết. Đặc biệt, công nghệ NFC (in, quét trên điện thoại thông minh của bạn bằng cách chạm smartphone của bạn vào máy) cũng được áp dụng trên sản phẩm này.
          </p>
                ...
                <div className="mt-12">
                  ...
                  <div className="space-y-6 text-[15px] text-black leading-relaxed">
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        <li>Năng suất cao với tốc độ in cao lên đến 75 trang/phút</li>
                        <li>Khay tiêu chuẩn chứa 4.645 tờ  (có thể nâng lên đến 8.800 tờ) để bạn có thể in liên tục mà không bị ngắt quãng</li>
