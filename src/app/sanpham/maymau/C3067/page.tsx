...
const product = {
  ...
  image: "/productsColor/Apeos C3567.png",
   specs: [
    ...
    'Tốc độ sao in (A4 LEF): Đen trắng 30 trang/phút – Màu 30 trang/phút',
    ...
    'Tốc độ sao chụp qua DADF (A4 LEF, 1 mặt): Đen trắng 30 trang/phút - Màu 30 trang/phút;',
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            ...
            <li>Tốc độ In/sao chụp qua DADF 30 trang/phút.</li>
      ...
      <div className="mt-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 w-full">
          ...
          <h3 className="text-[30px] font-bold text-red-700 mb-2">
            Máy Photocopy Apeos C3067
          </h3>
          <h4 className="text-lg font-semibold text-blue-700 mb-2">
            Thời đại mới, Apeos mới
          </h4>
          <p className="text-black text-justify mb-4">
            <strong>Apeos 3067</strong> Máy photocopy Fujifilm Apeos C3067 là một lựa chọn tuyệt vời dành cho các văn phòng và doanh nghiệp hiện đại. Với khả năng in, sao chép và quét mạng màu, model này mang đến hiệu suất vượt trội cùng chất lượng hình ảnh sắc nét.
          </p>
