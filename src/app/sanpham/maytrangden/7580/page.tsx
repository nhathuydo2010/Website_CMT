...
const product = {
  ...
  specs: [
    "Máy Photocopy kỹ thuật số, Laser trắng đen (Apeos 7580)",
    "Chức năng: Copy + In trắng đen + Scan màu + Fax (tùy chọn)",
    "Bộ nạp và đảo bản gốc tự động (DADF) dung lượng 250 tờ",
    "Bộ đảo bản sao tự động (Duplex) hỗ trợ in 2 mặt",
    "Tốc độ sao chụp: 75 bản/phút với khổ A4 LEF",
    ...
    "Bộ nhớ: RAM 4GB (tối đa 4GB) + SSD 128GB ",
    "Kết nối mạng: Ethernet, USB, tùy chọn Wi-Fi (Wireless LAN)",
    "Tốc độ scan: 135 trang/phút (1 mặt), 270 tờ/phút (2 mặt)",
