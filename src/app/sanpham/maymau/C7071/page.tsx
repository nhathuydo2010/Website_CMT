...
const product = {
  ...
  'Tốc độ sao in (A4 LEF): Đen trắng 70 trang/phút – Màu 70 trang/phút',
  ...
  'Tốc độ sao chụp qua DADF (A4 LEF, 1 mặt): Đen trắng 70 trang/phút – Màu 70 trang/phút',
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            ...
            <li>Tốc độ In/sao chụp qua DADF 70 trang/phút.</li>
