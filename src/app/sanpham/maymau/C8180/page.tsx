...
const product = {
  ...
  specs: [
    ...
    "Thời gian khởi động (có kích hoạt): 36 giây hoặc ít hơn",
    "Thời gian khởi động (không kích hoạt): 30 giây hoặc ít hơn",
    "Thời gian khôi phục từ chế độ nghỉ: 30 giây hoặc ít hơn",
    "Khổ giấy bản gốc: Tối đa A3, 11 x 17 inch, 297 x 432 mm",
    "Khổ giấy in: Tối đa 330 x 483 mm, tối thiểu A6, bưu thiếp (100 x 148 mm)",
    "Chiều rộng mất hình: Trên/dưới 4 mm, trái/phải 3 mm",
    "Trọng lượng giấy (khay & khay tay): 52 – 300 gsm",
    "Thời gian ra bản sao đầu tiên: Đen trắng 4.1 giây, Màu 5.4 giây (A4 LEF)",
    "Tốc độ sao chụp A4 LEF / JIS B5 LEF: Đen trắng & màu: 81 trang/phút",
    "Tốc độ sao chụp A4 / JIS B5: Đen trắng & màu: 60 trang/phút",
    "Tốc độ sao chụp JIS B4: Đen trắng & màu: 46 trang/phút",
    "Tốc độ sao chụp A3: Đen trắng & màu: 42 trang/phút",
    ...
    "Chế độ nghỉ: 0.5 W, chế độ điện thấp: 134 W, chế độ sẵn sàng: 193 W",
    ...
    "Hệ điều hành hỗ trợ (PCL): Windows 10/8.1 (32/64-bit), Server 2012–2019 (64-bit), macOS 10.12–11",
    "Hệ điều hành hỗ trợ (PostScript): Windows 10/8.1 (32/64-bit), Server 2012–2019 (64-bit), macOS 10.12–11",
    "Kết nối: Ethernet 1000BASE-T / 100BASE-TX / 10BASE-T, USB 3.0 / 2.0, Wi-Fi (tùy chọn)",
    "Kiểu quét: Màu",
    "Độ phân giải quét: 600 / 400 / 300 / 200 dpi",
    "Tốc độ quét: Theo tốc độ bộ nạp gốc tự động (SPDF)",
    "Kết nối: Ethernet (chuẩn), Wi-Fi (tùy chọn)",
    "Khổ giấy bản gốc: Tối đa A3, 11 x 17 inch; Tối thiểu A6",
    "Trọng lượng giấy: 38 – 200 gsm (2 mặt: 50 – 200 gsm)",
    "Dung lượng nạp: 250 tờ",
    "Tốc độ sao chụp qua SPDF (A4 LEF, 1 mặt): Đen trắng & màu: 81 trang/phút",
    "Tốc độ quét: Đen trắng & màu: 135 trang/phút",
    "Tốc độ quét 1 lượt 2 mặt: Đen trắng & màu: 270 trang/phút",
    "Lưu trữ: Tài liệu chuẩn (A4), 200 dpi, lưu vào thư mục"
  ]
};
      ...
      <div className="mt-12 flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3 w-full">
          ...
          <h3 className="text-[30px] font-bold text-red-700 mb-2">
            Máy photocopy màu FUJIFILM Apeos C8180
          </h3>
          <h4 className="text-lg font-semibold text-blue-700 mb-2">
            Thời đại mới, Apeos mới
          </h4>
          <p className="text-black text-justify mb-4">
            <strong>Máy photocopy màu FUJIFILM Apeos C8180</strong> không chỉ đơn thuần là một thiết bị in ấn mà còn là một hệ thống quản lý tài liệu toàn diện. Với tốc độ in vượt trội, khả năng bảo mật cao và tích hợp công nghệ hiện đại, máy là giải pháp lý tưởng cho các doanh nghiệp cần tối ưu hóa quy trình làm việc và đảm bảo chất lượng in ấn cao nhất.
          </p>
