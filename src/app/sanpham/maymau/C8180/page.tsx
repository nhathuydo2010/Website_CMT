...
specs: [
  ...
  'Khổ giấy bản gốc: Tối đa A3, 11 x 17”, 297 x 432 mm',
  ...
  'Tốc độ sao in (A4 LEF): Đen trắng 80 trang/phút – Màu 80 trang/phút',
  ...
  'Mức tiêu thụ điện: 2,4 kW (Chế độ nghỉ: 0,5 W, Chế độ sẵn sàng: 134 W)',
  ...
  'Tốc độ sao chụp qua DADF (A4 LEF, 1 mặt): Đen trắng 80 trang/phút – Màu 80 trang/phút',
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <ul className="list-disc list-inside text-sm text-gray-700 space-y-1">
            <li>04 khay tự & 01 khay tay </li>
            <li>Tốc độ In/sao chụp qua DADF 80 trang/phút</li>
