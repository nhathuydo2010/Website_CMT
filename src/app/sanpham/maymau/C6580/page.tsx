...
const product = {
  ...
  'Tốc độ sao in (A4 LEF): Đen trắng 65 trang/phút – Màu 65 trang/phút',
  ...
  'Tốc độ sao chụp qua DADF (A4 LEF, 1 mặt): Đen trắng 65 trang/phút – Màu 65 trang/phút',
                ...
                <div className="mt-12">
                  ...
                  <div className="space-y-6 text-[15px] text-black leading-relaxed">
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-1">
                        <li>Tốc độ in cao, lên đến 81 trang/phút<sup></sup></li>
